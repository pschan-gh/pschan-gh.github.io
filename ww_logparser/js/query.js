                        ...
                        <form onSubmit={e => this.props.handlequery(e, this.state.queryItems)}>
                            <div className="modal-body">
                                {this.state.queryItems.map((item, index) => {
                                    return (
                                        <QueryItem key={index} querykey={index} field={item.field} conjunction={item.conjunction} condition={item.condition} headers={this.state.headers} handleconjunction={this.handleConjunction} handleselect={this.handleSelect} handlecondition={this.handleCondition} removequery={this.removeQuery.bind(this)}/>
                                    )
                                })}
                                <div className="row my-1 g-3"> 
                                    <div className="col-auto">
